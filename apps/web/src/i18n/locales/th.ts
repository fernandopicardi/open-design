...
export const th: Dict = {
  ...
  'designFiles.emptyNoMatch': 'ไม่มีไฟล์ที่ตรงกับการค้นหาของคุณ',
  ...
  'fileViewer.exportFigma': 'ส่งออกไปยัง Figma',
  'fileViewer.exportFigmaFailed': 'ส่งออกไปยัง Figma ล้มเหลว กรุณาลองอีกครั้ง',
