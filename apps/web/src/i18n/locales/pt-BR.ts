...
export const ptBR: Dict = {
  ...
  'designFiles.emptyNoMatch': 'Nenhum arquivo corresponde à sua busca.',
  ...
  'fileViewer.exportFigma': 'Exportar para o Figma',
  'fileViewer.exportFigmaFailed': 'Falha ao exportar para o Figma. Tente novamente.',
