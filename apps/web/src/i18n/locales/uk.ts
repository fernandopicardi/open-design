...
export const uk: Dict = {
  ...
  'designFiles.emptyNoMatch': 'Немає файлів, що відповідають запиту.',
  ...
  'fileViewer.exportFigma': 'Експорт у Figma',
  'fileViewer.exportFigmaFailed': 'Не вдалося експортувати у Figma. Спробуйте ще раз.',
