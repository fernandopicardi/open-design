...
export const ru: Dict = {
  ...
  'designFiles.emptyNoMatch': 'Нет файлов, соответствующих вашему запросу.',
  ...
  'fileViewer.exportFigma': 'Экспорт в Figma',
  'fileViewer.exportFigmaFailed': 'Не удалось экспортировать в Figma. Попробуйте ещё раз.',
