...
export const fa: Dict = {
  ...
  'designFiles.emptyNoMatch': 'هیچ فایلی با جستجوی شما مطابقت ندارد.',
  'designFiles.up': 'بالا',
  ...
  'fileViewer.exportFigma': 'برون‌بری به Figma',
  'fileViewer.exportFigmaFailed': 'برون‌بری به Figma ناموفق بود. لطفاً دوباره تلاش کنید.',
