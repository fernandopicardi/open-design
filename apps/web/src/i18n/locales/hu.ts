...
export const hu: Dict = {
  ...
  'designFiles.emptyNoMatch': 'Nincs a keresésnek megfelelő fájl.',
  'designFiles.up': 'Fel',
  ...
  'fileViewer.exportFigma': 'Exportálás Figmába',
  'fileViewer.exportFigmaFailed': 'A Figma-exportálás sikertelen. Kérjük, próbálja újra.',
