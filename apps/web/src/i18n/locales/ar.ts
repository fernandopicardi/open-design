...
export const ar: Dict = {
  ...
  'designFiles.emptyNoMatch': 'لا توجد ملفات تطابق بحثك.',
  ...
  'fileViewer.exportFigma': 'تصدير إلى Figma',
  'fileViewer.exportFigmaFailed': 'فشل التصدير إلى Figma. يرجى المحاولة مرة أخرى.',
