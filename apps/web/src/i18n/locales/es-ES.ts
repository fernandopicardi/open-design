...
export const esES: Dict = {
  ...
  'designFiles.emptyNoMatch': 'Ningún archivo coincide con tu búsqueda.',
  ...
  'fileViewer.exportFigma': 'Exportar a Figma',
  'fileViewer.exportFigmaFailed': 'Error al exportar a Figma. Inténtalo de nuevo.',
